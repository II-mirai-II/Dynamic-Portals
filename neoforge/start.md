Title: Getting Started with NeoForge | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/gettingstarted/

Markdown Content:
This section includes information about how to set up a NeoForge workspace, and how to run and test your mod.

## Prerequisites[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#prerequisites "Direct link to Prerequisites")
...
*   An installation of the Java 21 Development Kit (JDK) and 64-bit Java Virtual Machine (JVM). NeoForge recommends and officially supports the [Microsoft builds of OpenJDK](https://learn.microsoft.com/en-us/java/openjdk/download#openjdk-21), but any other JDK should work as well.
...
*   Familiarity with an Integrated Development Environment (IDE) of your choice.
    *   NeoForge officially supports [IntelliJ IDEA](https://www.jetbrains.com/idea/) and [Eclipse](https://www.eclipse.org/downloads/), both of which have integrated Gradle support. However, any IDE can be used, ranging from Netbeans or Visual Studio Code to Vim or Emacs.

*   Familiarity with [Git](https://www.git-scm.com/) and [GitHub](https://github.com/). This is technically not required, but it will make your life a lot easier.

## Setting Up the Workspace[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#setting-up-the-workspace "Direct link to Setting Up the Workspace")

*   Open the Mod Developer Kit (MDK) (either [ModDevGradle](https://github.com/NeoForgeMDKs/MDK-1.21-ModDevGradle) or [NeoGradle](https://github.com/NeoForgeMDKs/MDK-1.21-NeoGradle)) GitHub repository, click "Use this template" and clone the newly-created repository to your local machine.
...
## Customizing Your Mod Information[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#customizing-your-mod-information "Direct link to Customizing Your Mod Information")
...
If you want to modify the build process beyond that, you can edit the `build.gradle` file. NeoGradle, the Gradle plugin for NeoForge, provides several configuration options, a few of which are explained by comments in the `build.gradle` files. For full documentation, see the [NeoGradle documentation](https://docs.neoforged.net/neogradle/docs/).
...
## Building and Testing Your Mod[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#building-and-testing-your-mod "Direct link to Building and Testing Your Mod")
...
### Server Testing[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#server-testing "Direct link to Server Testing")
...
You should always test your mod in a dedicated server environment. This includes [client-only mods](https://docs.neoforged.net/docs/1.21.1/concepts/sides), as these should not do anything when loaded on the server.