Title: Resource Locations | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/misc/resourcelocation

Markdown Content:
`ResourceLocation`s are one of the most important things in Minecraft. They are used as keys in [registries](https://docs.neoforged.net/docs/1.21.1/concepts/registries), as identifiers for data or resource files, as references to models in code, and in a lot of other places. A `ResourceLocation` consists of two parts: a namespace and a path, separated by a `:`.
...
## Resolving `ResourceLocation`s[​](https://docs.neoforged.net/docs/1.21.1/misc/resourcelocation#resolving-resourcelocations "Direct link to resolving-resourcelocations")
...
## `ModelResourceLocation`s[​](https://docs.neoforged.net/docs/1.21.1/misc/resourcelocation#modelresourcelocations "Direct link to modelresourcelocations")
...
`ModelResourceLocation` is a [client only](https://docs.neoforged.net/docs/1.21.1/concepts/sides) class. This means that servers referencing this class will crash with a `NoClassDefFoundError`.

## `ResourceKey`s[​](https://docs.neoforged.net/docs/1.21.1/misc/resourcelocation#resourcekeys "Direct link to resourcekeys")
