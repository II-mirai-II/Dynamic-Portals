Title: Biome Modifiers | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier
...
### Recommended Section To Read:[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#recommended-section-to-read "Direct link to Recommended Section To Read:")

*   Players or pack developers:

    *   [Applying Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#applying-biome-modifiers)
    *   [Built-in Neoforge Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#built-in-biome-modifiers)

*   Modders doing simple additions or removal biome modifications:

    *   [Applying Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#applying-biome-modifiers)
    *   [Built-in Neoforge Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#built-in-biome-modifiers)
    *   [Datagenning Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#datagenning-biome-modifiers)

*   Modders who want to do custom or complex biome modifications:

    *   [Applying Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#applying-biome-modifiers)
    *   [Creating Custom Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#creating-custom-biome-modifiers)
    *   [Datagenning Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#datagenning-biome-modifiers)

## Applying Biome Modifiers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#applying-biome-modifiers "Direct link to Applying Biome Modifiers")

To have NeoForge load a biome modifier JSON file into the game, the file will need to be under `data/<modid>/neoforge/biome_modifier/<path>.json` folder in the mod's resources, or in a [Datapack](https://docs.neoforged.net/docs/1.21.1/resources/#data). Then, once NeoForge loads the biome modifier, it will read its instructions and apply the described modifications to all target biomes when the world is loaded up. Pre-existing biome modifiers from mods can be overridden by datapacks having a new JSON file at the exact same location and name.

The JSON file can be created by hand following the examples in the '[Built-in NeoForge Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#built-in-biome-modifiers)' section or be datagenned as shown in the '[Datagenning Biome Modifiers](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#datagenning-biome-modifiers)' section.

## Built-in Biome Modifiers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#built-in-biome-modifiers "Direct link to Built-in Biome Modifiers")

These biome modifiers are registered by NeoForge for anyone to use.

### None[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#none "Direct link to None")
...
### Add Features[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#add-features "Direct link to Add Features")

This biome modifier type adds `PlacedFeature`s (such as trees or ores) to biomes so that they can spawn during world generation. The modifier takes in the biome id or tag of the biomes the features are added to, a `PlacedFeature` id or tag to add to the selected biomes, and the [`GenerationStep.Decoration`](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#Available-Values-for-Decoration-Steps) the features will be generated within.
...
### Remove Features[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#remove-features "Direct link to Remove Features")

This biome modifier type removes features (such as trees or ores) from biomes so that they will no longer spawn during world generation. The modifier takes in the biome id or tag of the biomes the features are removed from, a `PlacedFeature` id or tag to remove from the selected biomes, and the [`GenerationStep.Decoration`](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#Available-Values-for-Decoration-Steps)s that the features will be removed from.
...
### Add Spawns[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#add-spawns "Direct link to Add Spawns")
...
### Remove Spawns[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#remove-spawns "Direct link to Remove Spawns")
...
### Add Spawn Costs[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#add-spawn-costs "Direct link to Add Spawn Costs")
...
### Remove Spawn Costs[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#remove-spawn-costs "Direct link to Remove Spawn Costs")
...
### Add Legacy Carvers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#add-legacy-carvers "Direct link to Add Legacy Carvers")
...
### Removing Legacy Carvers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#removing-legacy-carvers "Direct link to Removing Legacy Carvers")
...
### Available Values for Decoration Steps[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#available-values-for-decoration-steps "Direct link to Available Values for Decoration Steps")
...
## Creating Custom Biome Modifiers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#creating-custom-biome-modifiers "Direct link to Creating Custom Biome Modifiers")

### The `BiomeModifier` Implementation[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#the-biomemodifier-implementation "Direct link to the-biomemodifier-implementation")

Under the hood, Biome Modifiers are made up of three parts:

*   The [datapack registered](https://docs.neoforged.net/docs/1.21.1/concepts/registries#datapack-registries)`BiomeModifier` used to modify the biome builder.
*   The [statically registered](https://docs.neoforged.net/docs/1.21.1/concepts/registries#methods-for-registering)`MapCodec` that encodes and decodes the modifiers.
...
All `BiomeModifier`s contain a `type` key that references the id of the `MapCodec` used for the `BiomeModifier`. The `codec` takes in the `MapCodec` that encodes and decodes the modifiers. This `MapCodec` is [statically registered](https://docs.neoforged.net/docs/1.21.1/concepts/registries#methods-for-registering), with its id used as the `type` of the `BiomeModifier`.
...
## Datagenning Biome Modifiers[​](https://docs.neoforged.net/docs/1.21.1/worldgen/biomemodifier#datagenning-biome-modifiers "Direct link to Datagenning Biome Modifiers")

A `BiomeModifier` JSON can be created through [data generation](https://docs.neoforged.net/docs/1.21.1/resources/#data-generation) by passing a `RegistrySetBuilder` to `DatapackBuiltinEntriesProvider`. The JSON will be placed at `data/<modid>/neoforge/biome_modifier/<path>.json`.

For more information on how `RegistrySetBuilder` and `DatapackBuiltinEntriesProvider` work, please see the article on [Data Generation for Datapack Registries](https://docs.neoforged.net/docs/1.21.1/concepts/registries#data-generation-for-datapack-registries).
