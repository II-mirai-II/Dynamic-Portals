Title: Access Transformers | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers
...
## Adding ATs[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#adding-ats "Direct link to Adding ATs")
...
## The Access Transformer Specification[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#the-access-transformer-specification "Direct link to The Access Transformer Specification")

All text after a `#` until the end of the line will be treated as a comment and will not be parsed.

### Access Modifiers[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#access-modifiers "Direct link to Access Modifiers")
...
### Targets and Directives[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#targets-and-directives "Direct link to Targets and Directives")

#### Classes[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#classes "Direct link to Classes")
...
#### Fields[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#fields "Direct link to Fields")

To target fields:

`<access modifier> <fully qualified class name> <field name>`

#### Methods[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#methods "Direct link to Methods")

Targeting methods require a special syntax to denote the method parameters and return type:

`<access modifier> <fully qualified class name> <method name>(<parameter types>)<return type>`

##### Specifying Types[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#specifying-types "Direct link to Specifying Types")
...
### Examples[​](https://docs.neoforged.net/docs/1.21.1/advanced/accesstransformers#examples "Direct link to Examples")
