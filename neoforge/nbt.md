Title: Named Binary Tag (NBT) | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/datastorage/nbt
...
## Specification[​](https://docs.neoforged.net/docs/1.21.1/datastorage/nbt#specification "Direct link to Specification")
...
## NBT Files[​](https://docs.neoforged.net/docs/1.21.1/datastorage/nbt#nbt-files "Direct link to NBT Files")

Minecraft uses `.nbt` files extensively, for example for structure files in [datapacks](https://docs.neoforged.net/docs/1.21.1/resources/#data). Region files (`.mca`) that contain the contents of a region (i.e. a collection of chunks), as well as the various `.dat` files used in different places by the game, are NBT files as well.

NBT files are typically compressed with GZip. As such, they are binary files and cannot be edited directly.

## NBT in Code[​](https://docs.neoforged.net/docs/1.21.1/datastorage/nbt#nbt-in-code "Direct link to NBT in Code")
...
## Usages of NBT[​](https://docs.neoforged.net/docs/1.21.1/datastorage/nbt#usages-of-nbt "Direct link to Usages of NBT")

NBT is used in a lot of places in Minecraft. Some of the most common examples include [`BlockEntity`](https://docs.neoforged.net/docs/1.21.1/blockentities/)s and `Entity`s.

## See Also[​](https://docs.neoforged.net/docs/1.21.1/datastorage/nbt#see-also "Direct link to See Also")
