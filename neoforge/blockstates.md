Title: Blockstates | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/blocks/states
...
## Blockstate Properties[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#blockstate-properties "Direct link to Blockstate Properties")
...
`minecraft:end_portal_frame[facing=north,eye=false]minecraft:end_portal_frame[facing=east,eye=false]minecraft:end_portal_frame[facing=south,eye=false]minecraft:end_portal_frame[facing=west,eye=false]minecraft:end_portal_frame[facing=north,eye=true]minecraft:end_portal_frame[facing=east,eye=true]minecraft:end_portal_frame[facing=south,eye=true]minecraft:end_portal_frame[facing=west,eye=true]`
...
As with blocks, every `BlockState` exists exactly once in memory. This means that `==` can and should be used to compare `BlockState`s. `BlockState` is also a final class, meaning it cannot be extended. **Any functionality goes in the corresponding [Block](https://docs.neoforged.net/docs/1.21.1/blocks/) class!**

## When to Use Blockstates[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#when-to-use-blockstates "Direct link to When to Use Blockstates")

### Blockstates vs. Separate Blocks[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#blockstates-vs-separate-blocks "Direct link to Blockstates vs. Separate Blocks")
...
### Blockstates vs. [Block Entities](https://docs.neoforged.net/docs/1.21.1/blockentities/)[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#blockstates-vs-block-entities "Direct link to blockstates-vs-block-entities")
...
## Implementing Blockstates[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#implementing-blockstates "Direct link to Implementing Blockstates")
...
`// EndPortalFrameBlock.FACING is a DirectionProperty and thus can be used to obtain a Direction from the BlockStateDirection direction = endPortalFrameBlockState.getValue(EndPortalFrameBlock.FACING);`
...
### `Level#setBlock`[​](https://docs.neoforged.net/docs/1.21.1/blocks/states#levelsetblock "Direct link to levelsetblock")
