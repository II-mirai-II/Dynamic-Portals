Title: Structuring Your Mod | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/gettingstarted/structuring
...
## Packaging[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/structuring#packaging "Direct link to Packaging")
...
As such, your top level package should be something that you own: a domain, email address, a (subdomain of a) website, etc. It can even be your name or username as long as you can guarantee that it will be uniquely identifiable within the expected target. Furthermore, the top-level package should also match your [group id](https://docs.neoforged.net/docs/1.21.1/gettingstarted/#the-group-id).

| Type | Value | Top-Level Package |
| --- | --- | --- |
| Domain | example.com | `com.example` |
| Subdomain | example.github.io | `io.github.example` |
| Email | [example@gmail.com](mailto:example@gmail.com) | `com.gmail.example` |
...
### Sub-package Organization[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/structuring#sub-package-organization "Direct link to Sub-package Organization")
...
## Choose One Method from Many[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/structuring#choose-one-method-from-many "Direct link to Choose One Method from Many")
