Title: Debug Profiler | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/misc/debugprofiler
...
## Using the Debug Profiler[​](https://docs.neoforged.net/docs/1.21.1/misc/debugprofiler#using-the-debug-profiler "Direct link to Using the Debug Profiler")
...
## Reading a Profiling result[​](https://docs.neoforged.net/docs/1.21.1/misc/debugprofiler#reading-a-profiling-result "Direct link to Reading a Profiling result")
...
## Profiling your own code[​](https://docs.neoforged.net/docs/1.21.1/misc/debugprofiler#profiling-your-own-code "Direct link to Profiling your own code")
...
`ProfilerFiller#push(yourSectionName : String);//The code you want to profileProfilerFiller#pop();`
