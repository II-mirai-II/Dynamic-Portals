Title: Versioning | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning
...
## Minecraft[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#minecraft "Direct link to Minecraft")
...
### Snapshots[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#snapshots "Direct link to Snapshots")
...
### Pre-releases and Release Candidates[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#pre-releases-and-release-candidates "Direct link to Pre-releases and Release Candidates")
...
## NeoForge[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#neoforge "Direct link to NeoForge")

NeoForge uses an adapted semver system: The major version is Minecraft's minor version, the minor version is Minecraft's patch version, and the patch version is the "actual" NeoForge version. So for example, NeoForge 20.2.59 is the 60th version (we start at 0) for Minecraft 1.20.2. The `1` at the beginning is omitted because it is very unlikely that it will ever change, see [above](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#minecraft) for why that is the case.

A few places in NeoForge also use [Maven version ranges](https://maven.apache.org/enforcer/enforcer-rules/versionRanges.html), for example the Minecraft and NeoForge version ranges in the [`neoforge.mods.toml`](https://docs.neoforged.net/docs/1.21.1/gettingstarted/modfiles#neoforgemodstoml) file. These are mostly, but not fully compatible with semver (the `pre`-tag is not considered by it, for example).

## Mods[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#mods "Direct link to Mods")
...
### Semantic Versioning[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#semantic-versioning "Direct link to Semantic Versioning")
...
### "Reduced" and "Expanded" Semver[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#reduced-and-expanded-semver "Direct link to \"Reduced\" and \"Expanded\" Semver")
...
### Alpha, Beta, Release[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#alpha-beta-release "Direct link to Alpha, Beta, Release")
...
### Including the Minecraft Version[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#including-the-minecraft-version "Direct link to Including the Minecraft Version")
...
### Including the Mod Loader[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#including-the-mod-loader "Direct link to Including the Mod Loader")
...
### A Note on Maven[​](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#a-note-on-maven "Direct link to A Note on Maven")

Maven, the system used for dependency hosting, uses a versioning system that differs from semver in some details (though the general `major.minor.patch` pattern remains the same). The related [Maven Versioning Range (MVR)](https://maven.apache.org/enforcer/enforcer-rules/versionRanges.html) system is used in some places in NeoForge (see [above](https://docs.neoforged.net/docs/1.21.1/gettingstarted/versioning#neoforge)). When choosing your versioning scheme, you should make sure it is compatible with MVR, as otherwise, mods will not be able to depend on specific versions of your mod!