Title: The Interaction Pipeline | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline
...
## What Happens When I Right-Click?[​](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#what-happens-when-i-right-click "Direct link to What Happens When I Right-Click?")
...
## Result Types[​](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#result-types "Direct link to Result Types")
...
*   `InteractionResult#CONSUME_PARTIAL` is mostly identical to `InteractionResult#CONSUME`, the only difference is in its usage in [`Item#useOn`](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#itemuseon).
...
## `IItemExtension#onItemUseFirst`[​](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#iitemextensiononitemusefirst "Direct link to iitemextensiononitemusefirst")
...
## `Item#useOn`[​](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#itemuseon "Direct link to itemuseon")
...
## `Item#use`[​](https://docs.neoforged.net/docs/1.21.1/items/interactionpipeline#itemuse "Direct link to itemuse")
