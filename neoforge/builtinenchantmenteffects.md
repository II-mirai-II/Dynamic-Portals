Title: Built-In Enchantment Effect Components | NeoForged docs

URL Source: https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin

Markdown Content:
Vanilla Minecraft provides numerous different types of enchantment effect components for use in [enchantment](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/) definitions. This article will explain each, including their usage and in-code definition.

## Value Effect Components[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#value-effect-components "Direct link to Value Effect Components")

_See also [Value Effect Components](https://minecraft.wiki/w/Enchantment\_definition#Components\_with\_value\_effects) on the Minecraft Wiki_
...
`"effects": {    // The type of this effect component is "minecraft:damage".    // This means that the effect will modify weapon damage.    // See below for a list of more effect component types.    "minecraft:damage": [        {            // A value effect that should be applied.            // In this case, since there's only one, this value effect is just named "effect".            "effect": {                // The type of value effect to use. In this case, it is "minecraft:add", so the value (given below) will be added                 // to the weapon damage value.                "type": "minecraft:add",                // The value block. In this case, the value is a LevelBasedValue that starts at 1 and increases by 0.5 every enchantment level.                "value": {                    "type": "minecraft:linear",                    "base": 1.0,                    "per_level_above_first": 0.5                }            }        }    ]}`

The object within the `value` block is a [LevelBasedValue](https://docs.neoforged.net/docs/resources/server/loottables/#number-provider), which can be used to have a value effect component that changes the intensity of its effect by level.
...
`// `valueEffect` is an EnchantmentValueEffect instance.// `enchantLevel` is an integer representing the level of the enchantmentfloat baseValue = 1.0;float modifiedValue = valueEffect.process(enchantLevel, server.random, baseValue);`

### Vanilla Enchantment Value Effect Component Types[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#vanilla-enchantment-value-effect-component-types "Direct link to Vanilla Enchantment Value Effect Component Types")

#### Defined as `DataComponentType<EnchantmentValueEffect>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypeenchantmentvalueeffect "Direct link to defined-as-datacomponenttypeenchantmentvalueeffect")
...
#### Defined as `DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistconditionaleffectenchantmentvalueeffect "Direct link to defined-as-datacomponenttypelistconditionaleffectenchantmentvalueeffect")
...
*   `minecraft:fishing_luck_bonus`: Modifies the amount of [luck](https://minecraft.wiki/w/Luck) used in the fishing loot table. Used by Luck of the Sea.

#### Defined as `DataComponentType<List<TargetedConditionalEffect<EnchantmentValueEffect>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelisttargetedconditionaleffectenchantmentvalueeffect "Direct link to defined-as-datacomponenttypelisttargetedconditionaleffectenchantmentvalueeffect")

*   `minecraft:equipment_drops`: Modifies the chance of equipment dropping from an entity killed by this weapon. Used by Looting.

## Location Based Effect Components[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#location-based-effect-components "Direct link to Location Based Effect Components")

_See also: [Location Based Effect Components](https://minecraft.wiki/w/Enchantment\_definition#location\_changed) on the Minecraft Wiki_
...
*   `minecraft:apply_mob_effect`: Applies a [mob effect](https://docs.neoforged.net/docs/items/mobeffects/) to the affected mob.
*   `minecraft:attribute`: Applies an [attribute modifier](https://minecraft.wiki/w/Attribute#Modifiers) to the wielder of the enchantment.
...
*   `minecraft:run_function`: Runs a specified [datapack function](https://minecraft.wiki/w/Function_(Java_Edition)).
...
### Vanilla Location Based Effect Component Types[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#vanilla-location-based-effect-component-types "Direct link to Vanilla Location Based Effect Component Types")

#### Defined as `DataComponentType<List<ConditionalEffect<EnchantmentLocationBasedEffect>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistconditionaleffectenchantmentlocationbasedeffect "Direct link to defined-as-datacomponenttypelistconditionaleffectenchantmentlocationbasedeffect")
...
#### Defined as `DataComponentType<List<EnchantmentAttributeEffect>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistenchantmentattributeeffect "Direct link to defined-as-datacomponenttypelistenchantmentattributeeffect")
...
## Entity Effect Components[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#entity-effect-components "Direct link to Entity Effect Components")

_See also [Entity Effect Components](https://minecraft.wiki/w/Enchantment\_definition#Components\_with\_entity\_effects) on the Minecraft Wiki._
...
### Vanilla Enchantment Entity Effect Component Types[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#vanilla-enchantment-entity-effect-component-types "Direct link to Vanilla Enchantment Entity Effect Component Types")

#### Defined as `DataComponentType<List<ConditionalEffect<EnchantmentEntityEffect>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistconditionaleffectenchantmententityeffect "Direct link to defined-as-datacomponenttypelistconditionaleffectenchantmententityeffect")
...
#### Defined as `DataComponentType<List<TargetedConditionalEffect<EnchantmentEntityEffect>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelisttargetedconditionaleffectenchantmententityeffect "Direct link to defined-as-datacomponenttypelisttargetedconditionaleffectenchantmententityeffect")
...
For more detail on each of these, please look at the [relevant minecraft wiki page](https://minecraft.wiki/w/Enchantment_definition#Components_with_entity_effects).

## Other Vanilla Enchantment Component Types[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#other-vanilla-enchantment-component-types "Direct link to Other Vanilla Enchantment Component Types")

#### Defined as `DataComponentType<List<ConditionalEffect<DamageImmunity>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistconditionaleffectdamageimmunity "Direct link to defined-as-datacomponenttypelistconditionaleffectdamageimmunity")

*   `minecraft:damage_immunity`: Applies immunity to a specified damage type. Used by Frost Walker.

#### Defined as `DataComponentType<Unit>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypeunit "Direct link to defined-as-datacomponenttypeunit")
...
#### Defined as `DataComponentType<List<CrossbowItem.ChargingSounds>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistcrossbowitemchargingsounds "Direct link to defined-as-datacomponenttypelistcrossbowitemchargingsounds")
...
#### Defined as `DataComponentType<List<Holder<SoundEvent>>>`[​](https://docs.neoforged.net/docs/1.21.1/resources/server/enchantments/builtin#defined-as-datacomponenttypelistholdersoundevent "Direct link to defined-as-datacomponenttypelistholdersoundevent")
