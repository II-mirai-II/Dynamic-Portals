...
- 🎯 **Progressive Unlocking**: Hunt mobs to unlock Nether and End portals
- 👾 **Monster Hunting**: Defeat specific creatures and bosses for each dimension
...
**Required Mobs (kill at least 1 of each):**
...
```bash
git clone https://github.com/II-mirai-II/Dynamic-Portals.git
cd Dynamic-Portals
gradlew build
```
